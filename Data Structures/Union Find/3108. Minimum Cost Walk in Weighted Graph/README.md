<h1><a href="https://leetcode.com/problems/minimum-cost-walk-in-weighted-graph/description/?envType=daily-question&envId=2025-03-20">3108. Minimum Cost Walk in Weighted Graph</a></h1>
...
><strong>Input:</strong> <span class="example-io">n = 5, edges = [[0,1,7],[1,3,7],[1,2,1]], query = [[0,3],[3,4]]</span></p>
><strong>Output:</strong> <span class="example-io">[1,-1]</span></p>
